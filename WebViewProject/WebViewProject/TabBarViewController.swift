...
class TabbBarViewController: UITabBarController {
    ...
    func configureTabBar() {
        ...
        let firstViewControler = storyboard.instantiateViewController(withIdentifier: "WebViewController")
        ...
        let secondViewController = storyboard.instantiateViewController(withIdentifier: "BackForWard")
        ...
        let thirdViewController = storyboard.instantiateViewController(withIdentifier: "GoForWard")
